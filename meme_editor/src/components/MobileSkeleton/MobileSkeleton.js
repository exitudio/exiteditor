...
function MobileSkeleton({ mobileHeadColor, isWhiteTextHeader, children }) {
  return (
    <div className="all-mobile">
      <div className="border-wrapper">
        <ScaleComponent scale={0.5}>
          ...
          >
            <header
              style={{ backgroundColor: mobileHeadColor }}
              className={`${isWhiteTextHeader ? "white" : ""}`}
            >
              <img
                src={isWhiteTextHeader ? signalWhite : signal}
                alt="signal"
              />
              ...
              <img src={isWhiteTextHeader ? wifiWhite : wifi} alt="wifi" />
              <div className="time" {...contentEditableProps}>
                <EditPopSign className="center top" />
                8:23 PM
              </div>
              <img src={isWhiteTextHeader ? gpsWhite : gps} alt="gps" />
              <div className="batter-percentage">50%</div>
              <img
                src={isWhiteTextHeader ? batteryWhite : battery}
                alt="battery"
              />
            </header>
            {children}
